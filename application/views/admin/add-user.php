                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <input type="text" name="firstname" class="form-control" placeholder="Enter your Firstname" value="<?php echo set_value('firstname'); ?>" required>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                <div class="form-line">
                                                                    ...
                                                                    <input type="text" name="lastname" class="form-control" placeholder="Enter your Lastname" value="<?php echo set_value('lastname'); ?>" required>
